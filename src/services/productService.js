...
const getProductMainCategories = async (
  ...
  if (sort) {
    return await productDao.mainCategoryFiltering(
      mainCategoryName,
      sort,
      firstDate,
      lastDate,
...
const getProductSubCategories = async (
  ...
  if (sort) {
    return await productDao.subCategoryFiltering(
      mainCategoryName,
      subCategoryName,
      sort,
      firstDate,
    ...
    return await productDao.getProductSubCategories(
      mainCategoryName,
      subCategoryName,
      userId
    );
...
const createProduct = async (
  ...
  const productId = await productDao.createProduct(
    userId,
    name,
    firstDate,
    lastDate,
